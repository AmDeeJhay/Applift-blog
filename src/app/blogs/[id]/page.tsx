...
//           <Link href="/who-we-are" className="text-gray-600 hover:text-gray-900">Who we are</Link>
//           <Link href="/our-people" className="text-gray-600 hover:text-gray-900">Our People</Link>
//           <Link href="/blogs" className="text-blue-600 font-medium">Our Blogs</Link>
//           <Link href="/contact-us" className="bg-gray-900 text-white px-4 py-2 rounded-md hover:bg-gray-800">Contact Us</Link>
//         </div>
//       </nav>
